...
var MyView = Backbone.View.extend({
   ...
   */
  countUp: function(){
    this.model.set({like: this.model.get('like') + 1});//setは自動的にthis.modelに用意されている。setを使うことでModelのデータを書き換えることができる。
  },
  render: function(){
    console.log('render');
...
new MyView({el: $("#app"), model: myModel});//Viewのインスタンス生成時に引数に、生成したモデルをプロパティとして渡してあげることで、ViewとModelが連結する(this.modelを使ってModelのデータを変更させることができる)
},{"../node_modules/backbone/backbone":1,"../node_modules/jquery/dist/jquery":2,"../node_modules/underscore/underscore":4}]},{},[5]);
